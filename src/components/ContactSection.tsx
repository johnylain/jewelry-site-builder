    ...
    <section id="contact" className="py-24 bg-card">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          {/* Right — CTA */}
          <div className="flex flex-col items-center justify-center bg-background border border-border p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="px-8 py-3 bg-primary text-primary-foreground text-sm font-medium tracking-wide uppercase transition-all hover:opacity-90"
              >
                Telegram
              </a>
              <a
                href="https://vk.com/im?sel=-36634991"
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-3 border border-border text-foreground text-sm font-medium tracking-wide uppercase transition-all hover:border-primary hover:text-primary"
              >
                VKontakte
              </a>
            </div>
